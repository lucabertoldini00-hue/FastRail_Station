...
public class LeggiDati {
    ...
    public ArrayList<Utente> leggiUtente() {
        try {
            ...
            FileReader apertura = new FileReader("./src/FastRailStation/salvataggioDati/utenti.txt");
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (linea.length >= 14) { // Controlla se la riga contiene almeno i dati essenziali
                    ...
                    if (inizioManutenzione != null) {
                        treno = new Treno(modello, provenienza, destinazione, compagnia, codice, numMax,
