...
public class PrenotazioneController
{
    ...
    private final String testoErroreLoggato = "ERRORE! bisogna effettuare il login";
    private final String testoErrorePersone = "ERRORE! bisogna scegliere le persone";
    private final String testoErroreClasse = "ERRORE! bisogna scegliere la classe";
    private final String testoErroreSelezionato = "ERRORE! bisogna scegliere un aereo";
    ...
    // Le colonne sono: Orario, ritardo, destinazione, n°treno, gate, compagnia, stato
    ...
    @FXML private TableColumn<Treno, String> colNTreno;
    ...
    public void initializeTable()
    {
        ...
        colNTreno.setCellValueFactory(cellData -> cellData.getValue().getCodiceProperty());
        colBinario.setCellValueFactory(cellData -> cellData.getValue().getBinarioProperty().asObject());
    ...
    private void handleDoubleClick(Treno treno)
    {
        isSelected = true;
