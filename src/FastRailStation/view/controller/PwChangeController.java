...
public class PwChangeController
{
    ...
    {
        boolean pieni = true;
        if (inserisciMail.getText().isEmpty()) { pieni = false; }
        else if (inserisciPassword.getText().isEmpty()) { pieni = false; }
        else if (confermaNuovaPassword.getText().isEmpty()) { pieni = false; }
        return pieni;
    }
